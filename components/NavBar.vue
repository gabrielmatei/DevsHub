      ...
      <ul class="navbar-nav">
        <li class="logo">
          <nuxt-link to="/" class="nav-link">
            <span class="link-text logo-text">{{ $t('navbar.homepage') }}</span>
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fad"
              ...
              viewBox="0 0 640 512"
              class="svg-inline--fa fa-terminal fa-w-20 fa-lg"
        ...
        <li class="nav-item">
          <nuxt-link to="/users" class="nav-link">
            ...
            ><g class="fa-group"><path fill="currentColor" d="M480 256a96 96 0 1 0-96-96 96 96 0 0 0 96 96zm48 32h-3.8c-13.9 4.8-28.6 8-44.2 8s-30.3-3.2-44.2-8H432c-20.4 0-39.2 5.9-55.7 15.4 24.4 26.3 39.7 61.2 39.7 99.8v38.4c0 2.2-.5 4.3-.6 6.4H592a48 48 0 0 0 48-48 111.94 111.94 0 0 0-112-112z" class="fa-secondary" /><path fill="currentColor" d="M192 256A112 112 0 1 0 80 144a111.94 111.94 0 0 0 112 112zm76.8 32h-8.3a157.53 157.53 0 0 1-68.5 16c-24.6 0-47.6-6-68.5-16h-8.3A115.23 115.23 0 0 0 0 403.2V432a48 48 0 0 0 48 48h288a48 48 0 0 0 48-48v-28.8A115.23 115.23 0 0 0 268.8 288z" class="fa-primary" /></g></svg>
            <span class="link-text">{{ $t('navbar.users') }}</span>
          </nuxt-link>
        </li>

        <li class="nav-item">
          <nuxt-link to="/contests" class="nav-link">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fad"
        ...
        <li v-if="role === 'admin'" class="nav-item">
          <nuxt-link to="/tutorials/categories" class="nav-link">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 576 512"
              class="svg-inline--fa fa-abacus fa-w-18 fa-lg"
            ><g class="fa-group"><path fill="currentColor" d="M192 440h-32v-48h32zM160 72v48h32V72zm96 160v48h32v-48zm-96 0v48h32v-48zm96 208h160v-48H256zm96-160h128v-48H352zM544 0a32 32 0 0 0-32 32v464a16 16 0 0 0 16 16h32a16 16 0 0 0 16-16V32a32 32 0 0 0-32-32zM416 72H256v48h160zM32 0A32 32 0 0 0 0 32v464a16 16 0 0 0 16 16h32a16 16 0 0 0 16-16V32A32 32 0 0 0 32 0z" class="fa-secondary" /><path fill="currentColor" d="M144 32h-32a16 16 0 0 0-16 16v96a16 16 0 0 0 16 16h32a16 16 0 0 0 16-16V48a16 16 0 0 0-16-16zm96 0h-32a16 16 0 0 0-16 16v96a16 16 0 0 0 16 16h32a16 16 0 0 0 16-16V48a16 16 0 0 0-16-16zm-96 160h-32a16 16 0 0 0-16 16v96a16 16 0 0 0 16 16h32a16 16 0 0 0 16-16v-96a16 16 0 0 0-16-16zm192 0h-32a16 16 0 0 0-16 16v96a16 16 0 0 0 16 16h32a16 16 0 0 0 16-16v-96a16 16 0 0 0-16-16zm-96 0h-32a16 16 0 0 0-16 16v96a16 16 0 0 0 16 16h32a16 16 0 0 0 16-16v-96a16 16 0 0 0-16-16zM464 32h-32a16 16 0 0 0-16 16v96a16 16 0 0 0 16 16h32a16 16 0 0 0 16-16V48a16 16 0 0 0-16-16zM144 352h-32a16 16 0 0 0-16 16v96a16 16 0 0 0 16 16h32a16 16 0 0 0 16-16v-96a16 16 0 0 0-16-16zm96 0h-32a16 16 0 0 0-16 16v96a16 16 0 0 0 16 16h32a16 16 0 0 0 16-16v-96a16 16 0 0 0-16-16zm224 0h-32a16 16 0 0 0-16 16v96a16 16 0 0 0 16 16h32a16 16 0 0 0 16-16v-96a16 16 0 0 0-16-16z" class="fa-primary" /></g></svg>
            <span class="link-text">{{ $t('navbar.tutorialCategories') }}</span>
          </nuxt-link>
        </li>

        <li class="nav-item">
          <nuxt-link to="/announcements" class="nav-link">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fad"
        ...
        <li v-else class="nav-item nav-item-user">
          <nuxt-link event="" to="/account" class="nav-link" @click.native="showAuthModal">
            ...
            >
              <g class="fa-group"><path fill="currentColor" d="M352 128A128 128 0 1 1 224 0a128 128 0 0 1 128 128z" class="fa-secondary" /><path fill="currentColor" d="M313.6 288h-16.7a174.1 174.1 0 0 1-145.8 0h-16.7A134.43 134.43 0 0 0 0 422.4V464a48 48 0 0 0 48 48h352a48 48 0 0 0 48-48v-41.6A134.43 134.43 0 0 0 313.6 288z" class="fa-primary" /></g>
            </svg>
            <span class="link-text">{{ $t('navbar.login') }}</span>
          </nuxt-link>
        </li>
      </ul>
    </nav>
    <AuthModal v-if="authModal && !isAuthenticated" @close="authModal = false" />
  </div>
</template>
